    ...
    <div class="row px-xl-5">
        <div class="col-lg-7 mb-5">
            <div class="contact-form bg-light p-30">
                ...
                <form action="{{ route('contact.store') }}" method="POST" name="sentMessage" id="contactForm" novalidate="novalidate">
                    ...
                    <div class="control-group">
                        <input type="email" class="form-control" id="email" name="email" value="{{ auth()->user()->email }}" placeholder="Your Email" required="required" readonly>
                    </div>
                    <div class="control-group">
        ...
        <div class="col-lg-5 mb-5">
            ...
            <div class="bg-light p-30 mb-3">
                ...
                <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>aziurofth@gmail.com</p>
